...
layout: post
author: teteteo619
title: 日誌の自動生成!!2つのコマンドだけで効率化を図る Part1 日誌自動生成編
date: 2023-04-20
thumbnail: /assets/img/posts/shellscript.png
category: shellscript
summary: シェルスクリプトで日誌を自動生成し、githubにプッシュ、slackに内容を表示できるようにスクリプトを書きコマンドを生成した話。
...
　そして、各変数にその日の日誌を書いた日のデータを代入します。dataというコマンドに下記のフォーマットを与えると戻り値として2023-04-20、2023-04のように値が返ってきます。その値を文字列として変数に入れています。
